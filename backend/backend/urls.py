...
from business.api.paper_recommend import get_recommendation, personal_recommend, refresh_personal_recommend
...
urlpatterns = [
    ...
    path('api/refreshPersonalRecommend', refresh_personal_recommend),
    # JWT认证模块
